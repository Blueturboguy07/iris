...
| `GuideAutopilotTerminalView.swift` | The SwiftUI terminal shown under the guide step card: renders the transcript and, when a risky command is waiting, the confirm row ("Run it"). |
