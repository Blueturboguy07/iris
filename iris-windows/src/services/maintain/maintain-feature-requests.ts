...
import { MaintainPoolClient, type PooledFeatureRequestEntry } from "./pool-client";
import { maintainTrace } from "./trace";

export type { PooledFeatureRequestEntry } from "./pool-client";
...
export class MaintainFeatureRequests {
   ...
   */
  async topRequests(appSlug: string): Promise<readonly PooledFeatureRequestEntry[]> {
